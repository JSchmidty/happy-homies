...
HOMIE_UPLOAD_MAX_BYTES = read_byte_limit_env(
    "ODYSSEUS_HOMIE_UPLOAD_MAX_BYTES", 5 * 1024 * 1024
)
HOMIE_VOICE_REF_MAX_BYTES = read_byte_limit_env(
    "ODYSSEUS_HOMIE_VOICE_REF_MAX_BYTES", 10 * 1024 * 1024
)
